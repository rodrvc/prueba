<?php
class EmailBlastsController extends AppController
{
	var $name = 'EmailBlasts';

	function admin_index()
	{
		$this->EmailBlast->recursive = 0;
		$this->set('emailBlasts', $this->paginate());
	}
	...
	function admin_view($id = null)
	{
		...
		$this->set('emailBlast', $this->EmailBlast->read(null, $id));
	}
	...
	function admin_add()
	{
		if ( ! empty($this->data) )
		{
			$this->EmailBlast->create();
			if ( $this->EmailBlast->save($this->data) )
			{
		...
		$administradores = $this->EmailBlast->Administrador->find('list');
	...
	function admin_edit($id = null)
	{
		...
		if ( empty($this->data) )
		{
			$this->data = $this->EmailBlast->read(null, $id);
		}
		$administradores = $this->EmailBlast->Administrador->find('list');
		$this->set(compact('administradores'));
	}
