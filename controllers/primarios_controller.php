<?php
class PrimariosController extends AppController
{
	var $name = 'Primarios';

	function admin_index()
	{
		$this->Primario->recursive = 0;
		$this->set('primarios', $this->paginate());
	}
	...
	function admin_view($id = null)
	{
		...
		$this->set('primario', $this->Primario->read(null, $id));
	}
	...
	function admin_add()
	{
		if ( ! empty($this->data) )
		{
			$this->Primario->create();
			if ( $this->Primario->save($this->data) )
			{
	...
	function admin_edit($id = null)
	{
		...
		if ( empty($this->data) )
		{
			$this->data = $this->Primario->read(null, $id);
		}
	}
