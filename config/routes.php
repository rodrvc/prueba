...
Router::connect('/solicitar_devolucion', array('controller' => 'usuarios', 'action' => 'solicitar_devolucion'));
...
Router::connect('/catalogo/mujer/producto/*', array('controller' => 'productos', 'action' => 'view'));
Router::connect('/catalogo/hombre/producto/*', array('controller' => 'productos', 'action' => 'view'));
Router::connect('/catalogo/nina/producto/*', array('controller' => 'productos', 'action' => 'view'));
Router::connect('/catalogo/nino/producto/*', array('controller' => 'productos', 'action' => 'view'));
Router::connect('/catalogo/ropa/producto/*', array('controller' => 'productos', 'action' => 'view'));
Router::connect('/catalogo/reloj/producto/*', array('controller' => 'productos', 'action' => 'view'));

Router::connect('/detalle/*', array('controller' => 'productos', 'action' => 'redirect_old'));


Router::connect('/catalogo/*', array('controller' => 'productos', 'action' => 'catalogo'));
Router::connect('/despachos', array('controller' => 'compras', 'action' => 'estado_despacho'));
Router::connect('/boleta', array('controller' => 'compras', 'action' => 'detalle_boleta'));
Router::connect('/boletas', array('controller' => 'compras', 'action' => 'detalle_boleta'));
...
Router::connect('/combinadance',  array('controller' => 'productos', 'action' => 'cybermonday2016'));
...
Router::connect('/autocuidado', array('controller' => 'productos', 'action' => 'cybermonday2016'));
Router::connect('/autocuidado/women', array('controller' => 'productos', 'action' => 'cybermonday2016','mujer', 'url' => array('categoria' => 'mujer')));
Router::connect('/autocuidado/men', array('controller' => 'productos', 'action' => 'cybermonday2016', 'hombre', 'url' => array('categoria' => 'hombre')));
Router::connect('/autocuidado/girls', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nina', 'url' => array('categoria' => 'nina')));
Router::connect('/autocuidado/boys', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nino', 'url' => array('categoria' => 'nino')));

Router::connect('/otono', array('controller' => 'productos', 'action' => 'cybermonday2016'));
Router::connect('/otono/women', array('controller' => 'productos', 'action' => 'cybermonday2016','mujer', 'url' => array('categoria' => 'mujer')));
Router::connect('/otono/men', array('controller' => 'productos', 'action' => 'cybermonday2016', 'hombre', 'url' => array('categoria' => 'hombre')));
Router::connect('/otono/girls', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nina', 'url' => array('categoria' => 'nina')));
Router::connect('/otono/boys', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nino', 'url' => array('categoria' => 'nino')));

Router::connect('/promo', array('controller' => 'productos', 'action' => 'cybermonday2016'));
Router::connect('/promo/women', array('controller' => 'productos', 'action' => 'cybermonday2016','mujer', 'url' => array('categoria' => 'mujer')));
Router::connect('/promo/men', array('controller' => 'productos', 'action' => 'cybermonday2016', 'hombre', 'url' => array('categoria' => 'hombre')));
Router::connect('/promo/girls', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nina', 'url' => array('categoria' => 'nina')));
Router::connect('/promo/boys', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nino', 'url' => array('categoria' => 'nino')));


Router::connect('/sale', array('controller' => 'productos', 'action' => 'cybermonday2016'));
Router::connect('/sale/women', array('controller' => 'productos', 'action' => 'cybermonday2016','mujer', 'url' => array('categoria' => 'mujer')));
Router::connect('/sale/men', array('controller' => 'productos', 'action' => 'cybermonday2016', 'hombre', 'url' => array('categoria' => 'hombre')));
Router::connect('/sale/girls', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nina', 'url' => array('categoria' => 'nina')));
Router::connect('/sale/boys', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nino', 'url' => array('categoria' => 'nino')));


Router::connect('/outlet', array('controller' => 'productos', 'action' => 'cybermonday2016'));
Router::connect('/outlet/women', array('controller' => 'productos', 'action' => 'cybermonday2016','mujer', 'url' => array('categoria' => 'mujer')));
Router::connect('/outlet/men', array('controller' => 'productos', 'action' => 'cybermonday2016', 'hombre', 'url' => array('categoria' => 'hombre')));
Router::connect('/outlet/girls', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nina', 'url' => array('categoria' => 'nina')));
Router::connect('/outlet/boys', array('controller' => 'productos', 'action' => 'cybermonday2016', 'nino', 'url' => array('categoria' => 'nino')));

Router::connect('/new', array('controller' => 'productos', 'action' => 'nuevo'));
Router::connect('/new/women', array('controller' => 'productos', 'action' => 'nuevo','mujer', 'url' => array('categoria' => 'mujer')));
Router::connect('/new/men', array('controller' => 'productos', 'action' => 'nuevo', 'hombre', 'url' => array('categoria' => 'hombre')));
Router::connect('/new/girls', array('controller' => 'productos', 'action' => 'nuevo', 'nina', 'url' => array('categoria' => 'nina')));
Router::connect('/new/boys', array('controller' => 'productos', 'action' => 'nuevo', 'nino', 'url' => array('categoria' => 'nino')));

Router::connect('/botas', array('controller' => 'productos', 'action' => 'cybermonday2016'));
...
Router::connect('/maxcushioning', array('controller' => 'productos', 'action' => 'grupos', 'max'));
Router::connect('/archfit', array('controller' => 'productos', 'action' => 'grupos', 'arch_fit'));
...
Router::connect('/carretecoreano', array('controller' => 'productos', 'action' => 'grupos', 'carrete','carrete.png'));

Router::connect('/heartlights', array('controller' => 'productos', 'action' => 'grupos', 'heart_lights'));
Router::connect('/chunky', array('controller' => 'productos', 'action' => 'grupos', 'chunky'));
Router::connect('/megacraft', array('controller' => 'productos', 'action' => 'grupos', 'mega_craft'));
Router::connect('/mensports', array('controller' => 'productos', 'action' => 'grupos', 'men_sport'));
Router::connect('/uno', array('controller' => 'productos', 'action' => 'grupos', 'uno'));
Router::connect('/streetwear', array('controller' => 'productos', 'action' => 'grupos', 'streetwear'));
Router::connect('/streetwear', array('controller' => 'productos', 'action' => 'grupos', 'streetwear'));
Router::connect('/cali', array('controller' => 'productos', 'action' => 'grupos', 'cali'));

Router::connect('/bobs', array('controller' => 'productos', 'action' => 'grupos', 'bobos_dogs'));

Router::connect('/collection/*', array('controller' => 'productos', 'action' => 'grupos'));
...
Router::connect('/api/orders/list', array('controller' => 'compras', 'action' => 'order_list'));
Router::connect('/api/orders/*', array('controller' => 'compras', 'action' => 'order_detail'));
