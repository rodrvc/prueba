...
Skechers. <br><br><b> Tu numero de orden es: '.$compra['Compra']['id'].'</b></h3>
	...
	{
		$mensaje .=' - Tu pedido ha sido recepcionado, durante las próximas 48 horas hábiles será enviado a tienda para retiro.<br>
- Una vez que esté disponible tu paquete en la tienda recibirás un correo de confirmación que deberás mostrar al momento del retiro junto con tu carnet de identidad. En caso de que hayas asignado a otra persona para retirarlo es importante que presente su carnet de identidad junto con una copia del correo de confirmación que te enviaremos.<br>
- No se entregarán compras sin presentar la correcta documentación antes descrita o a terceras personas no designadas al momento de hacer la compra. <br>
- Es importante que sepas que al momento de ir a la tienda no hay filas especiales para retiro, por lo que te recomendamos ir con tiempo y esperar tu turno.
</a> <br>
- Cuando tu producto sea despachado, enviaremos la boleta electrónica a este mismo correo<br>
- Si necesitas comunicarte con nosotros puedes contactarnos en https://www.skechers.cl/faq o contáctanos al correo ventas@skechers.com<br><br>';
	}else{
		$mensaje .='	Información Importante: <br>
- 	Tu compra ha sido recibida y comenzará su proceso de preparación en el próximo día hábil. Una vez preparada, será entregada a la empresa de transporte y se despachará en los plazos establecidos que puedes revisar en <a href="https://s3.amazonaws.com/andain-sckechers/politicas_skechers.pdf">Políticas de Envío</a><br>
