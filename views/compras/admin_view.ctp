	...
	<div class="col02">
		...
		<div class="previsualizar" rel="accordion-2">
			<ul>
				...
				<li><span><?= __('Resp. Transbank'); ?>:</span><p><? echo ($compra['Pago'][0]['respuesta']!='')?$compra['Pago'][0]['respuesta']:'<b>Sin Pago</b>'; ?></p></li>
			</ul>
			<div>
0 = Transacción aprobada<br>
-1 = Rechazo de transacción - Reintente (Posible error en el ingreso de datos de la transacción)<br>
-2 = Rechazo de transacción (Se produjo fallo al procesar la transacción. Este mensaje de rechazo está relacionado a parámetros de la tarjeta y/o su cuenta asociada)<br>
-3 = Error en transacción (Interno Transbank)<br>
-4 = Rechazo emisor (Rechazada por parte del emisor)<br>
-5 = Rechazo - Posible Fraude (Transacción con riesgo de posible fraude)<br>
