	...
	<table cellpadding="0" cellspacing="0" class="tabla">
		...
		<tr>
			<td class="estado-<?= $compra['Compra']['id']; ?>">
				...
				?>
				<a href="#" title="<?= $boton['title']; ?>"><img src="<?= $boton['imagen']; ?>" /></a>
			</td>
			<td><?= $compra['Compra']['id']; ?>&nbsp;</td>
			<td><?= $compra['Compra']['ip']; ?></td>
			...
			<td class="actions acciones-compras-<?= $compra['Compra']['id']; ?>">
				...
				// ACCIONES 
					...
					echo '<a href="'.$this->Html->url(array('action'=>'viewmv',$compra['Compra']['id'])).'" title="Ver"><img src="'.$this->Html->url('/img/iconos/clipboard_16.png').'" /></a>';
