	...
	<table cellpadding="0" cellspacing="0" class="tabla">
		...
		<tr>
			...
			<td class="actions acciones-compras-<?= $compra['Compra']['id']; ?>">
				...
				// ACCIONES 
				if ($botones['boleta'])
					echo '<a href="https://www.skechers.cl/boletas_skechers/'.$compra['Compra']['boleta_pdf'].'" target="_blank" title="Boleta"><img src="'.$this->Html->url('/img/iconos/document_16.png').'" /></a>';
