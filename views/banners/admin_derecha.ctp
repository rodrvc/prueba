<div class="col02">
	...
	<h1 class="titulo">
		<? __('Caluga Derecha');?>
		<a href="<?= $this->Html->url(array('action' => 'add','derecha')); ?>" class="btn-add">&raquo; agregar caluga</a>
	</h1>
	<table cellpadding="0" cellspacing="0" class="tabla">
		...
		<tr style="<?= ($banner['Banner']['activo'])?'background-color:#b3ffb3;':''; ?>">
			...
			<td class="actions">
				<?= $this->Html->link($this->Html->image('iconos/tick_16.png', array('title' => 'Activar')), array('action' => 'activar_derecha', $banner['Banner']['id']), array('escape' => false), sprintf(__('¿Estas seguro de activar la caluga # %s?', true), $banner['Banner']['id'])); ?>
