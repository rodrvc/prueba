	<div class="container">
					 <img src="https://s3.amazonaws.com/andain-sckechers/img/combinadance.jpg" width="100%"> 
	</div>
...
<div class="container">
	...
	<div class="top-catalogo" style="margin-top: 20px;">
		...
		<!--	<div class="col-md-9 col-xs-12 filtro">
				<a class="btn btn-default cyber" href="<?=$this->Html->url(array('controller' => 'cyber', 'action' => 'women'));?>">Women </a>
				<a class="btn btn-default cyber" href="<?=$this->Html->url(array('controller' => 'cyber', 'action' => 'men'));?>">Men </a>
				<a class="btn btn-default cyber" href="<?=$this->Html->url(array('controller' => 'cyber', 'action' => 'girls'));?>">Girls </a>
				<a class="btn btn-default cyber" href="<?=$this->Html->url(array('controller' => 'cyber', 'action' => 'boys'));?>">Boys </a>
			</div> -->
			<? if (isset($cont) && $cont) : ?>
