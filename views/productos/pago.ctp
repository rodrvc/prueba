...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body nopadding-top">
			...
			<div class="row">
 			...
 			<div class="jumbotron jumbotron-skechers">
 				<div class="container">
 					<div class="text-center"><?= $this->Html->image('tbp.png'); ?> widht="90"></div>
		...
		<form name="formulario" method="post" id="formulariotbk" action="<?= $result->url; ?>">
				<input name="token_ws" value="<?= $result->token; ?>" type="HIDDEN">
			</form>
