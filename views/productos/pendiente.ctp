		...
		<div class="panel-body nopadding-top">
			...
			<div class="page-header">
				<h1 class="text-center">
					...
					<br>Tu compra esta pendiente de verificacion del Pago.
					<br>Deberias recibir un correo confirmando tu compra dentro de las proximas 2 horas.
				</h1>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div id="documentoCompra" class="panel panel-default">
									...
									<tbody>
												...
												<tr>
													...
													<td class="text-center">
														<? if ( $producto['Producto']['oferta'] ) : ?>
															...
															<p>
																<span class="t">Oferta: <?= $this->Shapeups->moneda($producto['Producto']['precio_oferta'] * $producto['cantidad']); ?></span>
															</p>
														<? else : ?>
															<p>
																<b class="text-info">
										...
										<tr >
											<td colspan="2" rowspan="6" class="text-center">
												<img src="https://www.pngfind.com/pngs/m/424-4241421_logo-mercado-pago-png-mercadopago-transparent-png.png" width="70%">
											</td>
