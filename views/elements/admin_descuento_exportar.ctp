	...
	<div class="tools-panel">
		<div class="botones buscar" style="float: right; margin-bottom: 5px; margin-top: 0; width: 100%; border-bottom: 1px solid #000; padding-bottom: 15px;">
			<div class="conte-buscador">
				<?= $this->Form->create('Descuento', array('action' => 'buscador')); ?>
		...
		<div class="botones" style="float: right; margin-bottom: 5px; margin-top: 0; width: 100%; padding-bottom: 15px; border-bottom: 1px solid #000;">
			<a href="<?= $this->Html->url(array('controller' => 'descuentos', 'action' => 'exportar_codigos_validados')); ?>" class="btn-excel"><span class="excel">Exportar</span></a>
			<div class="texto-btn">
		...
		<div class="botones" style="float: right; margin-bottom: 5px; margin-top: 0; width: 100%;">
			<div class="texto-btn">
				<u><b>Carga masiva de descuentos a traves de csv</u></b>
			</div>
		</div>
		<div class="botones" style="float: right; margin-bottom: 5px; margin-top: 0; width: 100%; padding-bottom: 15px;">
			<a href="<?= $this->Html->url(array('controller' => 'descuentos', 'action' => 'masivo_add')); ?>" class="btn-excel"><span class="excel" style="background-image: url('<?= $this->Html->url('/img/iconos/up_16.png'); ?>');">Cargar</span></a>
			<a href="<?= $this->Html->url(array('controller' => 'descuentos', 'action' => 'masivo_listar')); ?>" class="btn-excel"><span class="excel" style="background-image: url('<?= $this->Html->url('/img/iconos/document_16.png'); ?>');">Listar</span></a>
		</div>
		<? endif; ?>
	</div>
	<script>
