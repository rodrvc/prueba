...
class Comuna extends AppModel
{
	...
	*/
	...
	var $hasMany = array(
	 ...
	 function calcularDespacho($comuna_id, $precio, $tipo = null)
	{
		$comuna = $this->find('first', array('conditions' => array(	'id' => $comuna_id		
											)));
		if(!$comuna)
				return false;
		if($precio >= $comuna['Comuna']['limite'])
		{
			return 0;
		}else{
		
			return $comuna['Comuna']['despacho1'];	
		}
	}
}
?>