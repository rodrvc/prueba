...
(function($) {
	...
	$.fn.coinslider= $.fn.CoinSlider = function(options){
		...
		$.setNavigation = function(el){
			...
			$('#cs-navigation-'+el.id).append("<a href='#' id='cs-prev-"+el.id+"' class='cs-prev'>" + texto_prev + "</a>");
			$('#cs-navigation-'+el.id).append("<a href='#' id='cs-next-"+el.id+"' class='cs-next'>" + texto_next + "</a>");
			$('#cs-prev-'+el.id).css({
				'position' 	: 'absolute',
