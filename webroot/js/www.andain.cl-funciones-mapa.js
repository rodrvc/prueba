...
function iniciarMapa()
{
	...
	// CUANDO CARGA EL MAPA, CARGAMOS LAS SUCURSALES
	google.maps.event.addListenerOnce(map, 'tilesloaded', function()
	{
		// IMPRIME LOS MARCADORES DE PERSONAS
		...
		for ( index in tiendas )
		{
			...
			{
				map				: map,
				icon			: new google.maps.MarkerImage(webroot + 'img/marcador.png',
...
{
	$('.tiendas .t-bloques .info-s .ver-map').click(function(evento)
	{
	...
	$('.opacidad .video .cerrar').click(function(evento)
	{
		evento.preventDefault();
		$('.opacidad').hide();
	});
